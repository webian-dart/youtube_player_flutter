...
class _YoutubePlayerBuilderState extends State<YoutubePlayerBuilder>
  ...
  void didChangeMetrics() {
    final physicalSize =
        SchedulerBinding.instance?.window.physicalSize ?? Size.zero;
    ...
    if (physicalSize.width > physicalSize.height) {
      ...
      if (widget.onEnterFullScreen != null) widget.onEnterFullScreen?.call();
    } else {
      controller.updateValue(controller.value.copyWith(isFullScreen: false));
      SystemChrome.setEnabledSystemUIOverlays(SystemUiOverlay.values);
      if (widget.onExitFullScreen != null) widget.onExitFullScreen?.call();
    }
